...
contract.on("CampaignCreated", (
    ...
    console.log(`Auction created with ID: ${_campaignId.toString()}`);
...
contract.on("CampaignEdited", (
    ...
    console.log(`Auction edited with ID: ${_campaignId.toString()}`);
...
contract.on("CampaignStatusChanged", (
    ...
    console.log(`Auction status changed with ID: ${_campaignId.toString()}`);
